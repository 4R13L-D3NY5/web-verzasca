          ...
          <div class="center-col">
            ...
            <div class="mt-4">
              <dl class="grid grid-cols-2 gap-4">
                <div><dt class="text-sm font-medium p-text">Fecha</dt><dd class="mt-1 p-text">{{ $etiquetadoSeleccionado['fecha_etiquetado'] ?? '-' }}</dd></div>
                <div><dt class="text-sm font-medium p-text">Encargado</dt><dd class="mt-1 p-text">{{ $etiquetadoSeleccionado['personal']['nombres'] ?? '-' }}</dd></div>
                <div><dt class="text-sm font-medium p-text">Producto</dt><dd class="mt-1 p-text">{{ $etiquetadoSeleccionado['existencia_producto_id'] ?? '-' }}</dd></div>
                <div><dt class="text-sm font-medium p-text">Etiqueta</dt><dd class="mt-1 p-text">{{ $etiquetadoSeleccionado['existencia_etiqueta_id'] ?? '-' }}</dd></div>
                <div><dt class="text-sm font-medium p-text">Generados</dt><dd class="mt-1 p-text">{{ $etiquetadoSeleccionado['cantidad_generada'] ?? 'Pendiente' }}</dd></div>
                <div class="col-span-2"><dt class="text-sm font-medium p-text">Observaciones</dt><dd class="mt-1 p-text">{{ $etiquetadoSeleccionado['observaciones'] ?? 'Ninguna' }}</dd></div>
              </dl>
            </div>
