            ...
            <tr class="color-bg border border-slate-200">
              <td class="px-6 py-4 p-text text-left">
                ...
                <div>
                  ...
                  <span>{{ number_format($existencia->cantidad) }}: {{ Str::limit($existencia->sucursal->nombre ?? 'Sucursal Desconocida', 15, '...') }}
                    </span><br>
                  @empty
                  <span class="text-xs text-gray-500">Sin stock registrado</span>
                  @endforelse
                  <strong class="p-text block mt-1">{{ number_format($base->existencias->sum('cantidad')) }}: Total bases
                    </strong>
                </div>
              </td>
