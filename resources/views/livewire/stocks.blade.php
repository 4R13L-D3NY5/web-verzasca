    ...
    <div>
      ...
      <div class="relative mt-3 w-full overflow-x-auto shadow-md sm:rounded-lg">
        ...
        <tr class="color-bg border border-slate-200">
          ...
          <div class="mb-2">
            <span class="font-semibold block">Producto:</span>
            <span>{{ $stock->producto->nombre ?? 'N/A' }}</span>
          </div>
          <div class="mb-2">
            <span class="font-semibold block">Etiqueta/capacidad:</span>
            <span>{{ $stock->etiqueta->capacidad ?? 'N/A' }}</span>
          </div>
          <div class="mb-2">
            <span class="font-semibold block">Elaboración:</span>
            <span>{{ $stock->fechaElaboracion }}</span>
          </div>
          <div class="mb-2">
            <span class="font-semibold block">Vencimiento:</span>
            <span>{{ $stock->fechaVencimiento }}</span>
          </div>
          <div class="mb-2">
            <span class="font-semibold block">Sucursal:</span>
            <span>{{ $stock->sucursal->nombre ?? 'N/A' }}</span>
          </div>
          <div>
            <span class="font-semibold block">Observaciones:</span>
            <span>{{ $stock->observaciones ?? 'Ninguna' }}</span>
          </div>
          </td>
