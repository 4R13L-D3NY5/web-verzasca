  ...
  <div class="w-full max-w-screen-xl grid grid-cols-1 gap-6">
    <div>
      ...
      <div class="flex justify-center items-center gap-4 w-full max-w-2xl mx-auto">
        ...
        <input type="text" wire:model.live="search" placeholder="Buscar por producto o sucursal..." class="input-g w-auto sm:w-64" />
      </div>
          ...
          <tbody>
            ...
            <tr class="color-bg border border-slate-200 text-sm">
              ...
              <td class="px-4 py-4 text-left align-top text-sm">
                ...
                <div><strong>Etiqueta:</strong> {{ $stock->etiqueta->capacidad ?? 'Sin etiqueta' }}-{{ $stock->etiqueta->cliente->nombre ?? 'Sin etiqueta' }}</div>
                <div><strong>Precio de referencia:</strong> {{ $stock->producto->precioReferencia ?? 'No definido' }}</div>
                <div><strong>Precio de referencia 2:</strong> {{ $stock->producto->precioReferencia2 ?? 'No definido' }}</div>
                <div><strong>Precio de referencia 3:</strong> {{ $stock->producto->precioReferencia3 ?? 'No definido' }}</div>
              </td>
    ...
    <div class="modal-center">
      <div class="modal-hiden">
        <div class="center-col">
          ...
          <!-- Botones -->
          <div class="mt-6 flex justify-center w-full space-x-4">
            <button type="button" wire:click="guardarExistencia" class="text-indigo-500 hover:text-indigo-600 mx-1 transition-transform duration-200 ease-in-out hover:scale-105 focus:outline-none focus:ring-2 focus:ring-indigo-500 rounded-full">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <button type="button" wire:click="cerrarModalExistencia" class="text-red-500 hover:text-red-600 mx-1 transition-transform duration-200 ease-in-out hover:scale-105 focus:outline-none focus:ring-2 focus:ring-red-500 rounded-full">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                class="icon icon-tabler icons-tabler-outline icon-tabler-x">
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
